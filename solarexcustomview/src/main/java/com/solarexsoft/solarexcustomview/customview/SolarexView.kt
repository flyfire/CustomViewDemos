 ...
 * <pre>
 *    Author: houruhou
 *    CreatAt: 15:23/2019/5/17
 *    Desc:
 * </pre>
 */
 
class SolarexView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyle: Int = 0) : View(context, attributeSet, defStyle) {
    var tag = SolarexView::class.java.simpleName
    var TAG = ""
    init {
        TAG = "$tag-$id"
    }
