...
public class DetectTouchEventViewEx extends View {
    ...
    public DetectTouchEventViewEx(Context context) {
        this(context, null);
    }

    public DetectTouchEventViewEx(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DetectTouchEventViewEx(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
